 ...
 * @author nisan
 */
public class Kopyası extends javax.swing.JFrame {
   ...
   Customer cus;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kopyası.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
